...
<%
Dim action__MMColParam
action__MMColParam = "1"
If (Request.QueryString("ref_num") <> "") Then 
  action__MMColParam = Request.QueryString("ref_num")
End If
%>
<%
Dim action
...
action.Source = "SELECT * FROM users WHERE ref_num = " + Replace(action__MMColParam, "'", "''") + ""
action.CursorType = 0
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0"><!--DWLayoutTable-->
  ...
  <tr> 
    ...
    <td rowspan="11" colspan="3" valign="top" bgcolor="#ffffff"><!-- InstanceBeginEditable name="Body" -->
      <p></p>
      <form action="takeaction.asp" method="get">
        <br>
        <br>
        <table width="80%" align="center">
          <tr valign="baseline"> 
            <td width="39%" align="right" nowrap><div align="left">User Requesting 
                ID :</div></td>
            <td width="61%"><%=(action.Fields.Item("user").Value)%> 
              <input name="method" type="hidden" id="method" value="<%=Request.QueryString("method")%>"> 
              <input name="ref_num" type="hidden" id="ref_num" value="<%=Request.QueryString("ref_num")%>"> 
            </td>
          </tr>
          <%
	...
	%>
          <tr valign="baseline"> 
            <td nowrap align="right"><div align="left">BCAC Approving Manager 
                :</div></td>
            <td> <input type="text" name="mgmt_approver" size="32"></td>
          </tr>
          <tr valign="baseline"> 
            <td nowrap align="right"><div align="left">BCAC Management Approval 
                Date :</div></td>
	...
	%>
          <tr valign="baseline"> 
            <td nowrap align="right"><div align="left">Security Manager Approver 
                :</div></td>
