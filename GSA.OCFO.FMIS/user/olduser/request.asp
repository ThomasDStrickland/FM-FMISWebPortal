  ...
  <table width="650" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td> <p> <span class="headtext"><br>
          External Users Only (Click here to activate fields below</span>)
          <input name="external" type="checkbox" onclick="enableDisable(this.checked,ex_agency,ex_lan,ex_ip,ex_email)" value="Yes">
        </p>
        </td>
    </tr>
    <tr> 
      <td><table width="100%"  border="0" cellpadding="0" cellspacing="0">
          ...
          <tr> 
            <th width="28%" scope="row"><div align="right">LAN Contact &amp; Phone 
                : </div></th>
            <td> <input name="ex_lan" type="text" id="ex_lan" disabled="disabled" style="background:#c0c0c0;"></td>
          </tr>
          <tr> 
            <th width="28%" scope="row"><div align="right">IP Address : </div></th>
            <td> <input name="ex_ip" type="text" id="ex_ip" disabled="disabled" style="background:#c0c0c0;"></td>
          </tr>
          <tr> 
            <th width="28%" scope="row"><div align="right">Email Address : </div></th>
