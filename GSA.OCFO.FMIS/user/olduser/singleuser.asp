  ...
  <tr> 
    <td> <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          ...
          <td width="84%"><%=(userinfo.Fields.Item("mgrphone").Value)%> </td>
        </tr>
        <tr> 
          <th width="22%" scope="row"> 
            <div align="right">Title : </div></th>
          <td width="84%"><%=(userinfo.Fields.Item("mgrtitle").Value)%> </td>
        </tr>
      </table></td>
  </tr>
  <tr> 
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <th width="22%" scope="row"> 
            <div align="right">Phone # : </div></th>
          <td width="84%"><%=(userinfo.Fields.Item("userphone").Value)%> </td>
        </tr>
        <tr> 
          <th width="22%" scope="row">
<div align="right">Reason ID Needed :</div></th>
  ...
  <tr>
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <th width="22%" scope="row">
<div align="right">UserID Assigned :</div></th>
