      ...
      <table width="75%" border="0" align="left">
        ...
        <tr> 
          <td> <table width="100%"  border="0">
              ...
              <tr> 
                <th width="24%" scope="row"> <div align="right">Title : </div></th>
        ...
        <tr> 
          <td><table width="100%"  border="0">
              ...
              <tr> 
                <th width="24%" scope="row"> <div align="right">Reason ID Needed 
                    :</div></th>
        ...
        <tr> 
          <td><table width="100%"  border="0">
              ...
              <tr> 
                <th width="24%" scope="row"> <div align="right">Question :</div></th>
                <td><%=(userinfo.Fields.Item("confques").Value)%></td>
              </tr>
              <tr> 
                <th width="24%" scope="row"> <div align="right">Answer :</div></th>
          ...
          <td><table width="100%"  border="0">
              ...
              <tr> 
                <th width="34%" scope="row"> <div align="right">BCAC Mgmt Approver 
                    :</div></th>
                <td width="34%"><%=(userinfo.Fields.Item("mgmt_approver").Value)%></td>
                <td width="32%"><strong>Date : </strong><%=(userinfo.Fields.Item("mgmt_app_date").Value)%></td>
              </tr>
              <tr> 
        ...
        <tr> 
          <td><table width="100%"  border="0">
              ...
              <tr> 
                <th width="34%" scope="row"> <div align="right">UserID Assigned 
                    :</div></th>
                <td width="66%"><%=(userinfo.Fields.Item("userid").Value)%></td>
              </tr>
            </table></td>
        </tr>
      </table>
