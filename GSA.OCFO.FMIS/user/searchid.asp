    ...
    <td rowspan="11" colspan="3" valign="top" bgcolor="#ffffff"><!-- InstanceBeginEditable name="Body" -->
      ...
      <form name="form1" method="get" action="completeid.asp">
        <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr> 
            <th width="240" scope="row"> <div align="left">View All UserIDs</div></th>
            <td width="410"><a href="completeid.asp">Click here to view all System 
              UserIDs</a><br> <br> </td>
          </tr>
          <tr> 
            <th scope="row"> <div align="left">Filter by System</div></th>
          ...
          <tr> 
            <th scope="row"> <div align="left">Filter by Internal/External Users</div></th>
            <td> <select name="external" id="external">
